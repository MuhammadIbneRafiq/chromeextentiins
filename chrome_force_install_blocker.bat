@echo off
REM === Force-install Chrome extension (prevents uninstall without admin) ===
...
echo Applying FORCE INSTALL policies for Chrome extension %EXT_ID% ...
...
echo.
echo Done! Extension is now FORCE INSTALLED - cannot be removed without admin privileges.
